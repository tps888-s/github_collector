...
LOCAL_REPO_BASE_PATH = os.getenv("LOCAL_REPO_BASE_PATH", ".\\tmp\\github_repos")
LOCAL_FILE_BLOBS_BASE_PATH = os.getenv("LOCAL_FILE_BLOBS_BASE_PATH", ".\\tmp\\github_file_blobs")
LOCAL_RAW_DIFFS_BASE_PATH = os.getenv("LOCAL_RAW_DIFFS_BASE_PATH", ".\\tmp\\github_raw_diffs")

# --- NEW: CSV Storage Paths ---
CSV_OUTPUT_BASE_PATH = os.getenv("CSV_OUTPUT_BASE_PATH", ".\\tmp\\github_csv_data")
